...
pub(super) trait ItemRef<ChildLayer: Layer, N: Node>: Copy {
    ...
    unsafe fn balance_to_left(
        ...
        ld_assert!(left_occupied < <Self::Item as Item>::B, "Balance failure.",);
        ...
        ld_assert!(is_right_balanced, "Balance-to-left failure.");
    ...
    unsafe fn balance_to_right(
        ...
        ld_assert!(right_occupied < <Self::Item as Item>::B, "Balance failure.",);
        ...
        ld_assert!(is_left_balanced, "Balance-to-right failure.");
