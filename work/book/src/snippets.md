...
The [Snippet](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/format/struct.Snippet.html)
...
the [Snippet::set_config](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/format/struct.Snippet.html#method.set_config)
...
the [Snippet::set_highlighter](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/format/struct.Snippet.html#method.set_highlighter)
function.

The highlighter is a stateful object that implements
the [Highlighter](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/format/trait.Highlighter.html)
trait and instructs the Snippet on how to stylize the source code tokens. The
Snippet builder
calls [Highlighter::token_style](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/format/trait.Highlighter.html#tymethod.token_style)
for each token in the source code sequentially, and the function returns
the [Style](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/format/struct.Style.html)
of the token.
