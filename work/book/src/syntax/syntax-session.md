...
The variable is of
type [SyntaxSession](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/syntax/trait.SyntaxSession.html),
...
of [TokenCursor](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/lexis/trait.TokenCursor.html),
...
the [TokenCursor::advance](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/lexis/trait.TokenCursor.html#tymethod.advance)
...
the [Recovery](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/syntax/struct.Recovery.html)
...
the [Recovery::unexpected](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/syntax/struct.Recovery.html#method.unexpected)
function adds a halting token, and
the [Recovery::group](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/syntax/struct.Recovery.html#method.group)
...
the [Recovery::recover](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/syntax/struct.Recovery.html#method.recover)
...
the [SyntaxSession::failure](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.failure)
function.
...
1. Call
   the [SyntaxSession::descend](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.descend)
   function, which gives control flow back to the parsing environment.
2. Create and parse the node manually using a pair of
   functions: [SyntaxSession::enter](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.enter)
   and [SyntaxSession::leave](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.leave).
...
The [SyntaxSession::lift](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.lift)
...
the [SyntaxSession::parent_ref](https://docs.rs/lady-deirdre/2.0.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.parent_ref)
