...
The variable is of
type [SyntaxSession](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/trait.SyntaxSession.html),
...
of [TokenCursor](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/lexis/trait.TokenCursor.html),
...
the [TokenCursor::advance](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/lexis/trait.TokenCursor.html#tymethod.advance)
function, which consumes one token and moves the stream position to the next
token,
or [TokenCursor::skip](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/lexis/trait.TokenCursor.html#tymethod.skip),
which allows you to consume several tokens.

For instance, in
the [Expr Parser](https://github.com/Eliah-Lakhin/lady-deirdre/blob/f350aaed30373a67694c3aba4d2cfd9874c2a656/work/crates/examples/src/expr_parser/parser.rs#L271)
...
the [Recovery](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/struct.Recovery.html)
...
the [Recovery::unexpected](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/struct.Recovery.html#method.unexpected)
function adds a halting token, and
the [Recovery::group](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/struct.Recovery.html#method.group)
...
the [Expr Parser](https://github.com/Eliah-Lakhin/lady-deirdre/blob/f350aaed30373a67694c3aba4d2cfd9874c2a656/work/crates/examples/src/expr_parser/parser.rs#L54)
...
the [Recovery::recover](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/struct.Recovery.html#method.recover)
...
the [SyntaxSession::failure](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.failure)
function.
...
1. Call
   the [SyntaxSession::descend](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.descend)
   function, which gives control flow back to the parsing environment.
2. Create and parse the node manually using a pair of
   functions: [SyntaxSession::enter](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.enter)
   and [SyntaxSession::leave](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.leave).
...
In
the [Expr Parser](https://github.com/Eliah-Lakhin/lady-deirdre/blob/f350aaed30373a67694c3aba4d2cfd9874c2a656/work/crates/examples/src/expr_parser/parser.rs#L230)
...
The [SyntaxSession::lift](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.lift)
...
the [Expr Parser](https://github.com/Eliah-Lakhin/lady-deirdre/blob/f350aaed30373a67694c3aba4d2cfd9874c2a656/work/crates/examples/src/expr_parser/parser.rs#L90)
example:
...
the [SyntaxSession::parent_ref](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.parent_ref)
function that returns a NodeRef reference to the parent node in the syntax tree
of the currently parsed node.

The [SyntaxSession::node_ref](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/trait.SyntaxSession.html#tymethod.node_ref)
