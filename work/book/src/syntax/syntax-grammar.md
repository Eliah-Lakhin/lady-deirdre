...
the [macro documentation](https://docs.rs/lady-deirdre/2.1.0/lady_deirdre/syntax/derive.Node.html)
...
- In `foo: $Bar?`, the "foo" field would have the type TokenRef because "Bar"
  ...
  value [TokenRef::nil](https://docs.rs/lady-deirdre/2.1.0/lady_deirdre/lexis/struct.TokenRef.html#method.nil).
...
2. **Always capture the start and end bounds of the node**.
   ...
   the [NodeRef::span](https://docs.rs/lady-deirdre/2.1.0/lady_deirdre/syntax/struct.NodeRef.html#method.span)
   function.
...
3. **Annotate the captured fields with the `#[child]` attribute**.
   ...
   For instance,
   the [traverse_tree](https://docs.rs/lady-deirdre/2.1.0/lady_deirdre/syntax/trait.SyntaxTree.html#method.traverse_tree)
