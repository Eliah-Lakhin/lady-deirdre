...
type [Semantics](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/analysis/struct.Semantics.html).
...
the [VoidFeature](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/analysis/struct.VoidFeature.html)
...
use
the [Semantics::new](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/analysis/struct.Semantics.html#method.new)
...
Feature trait using
the [Feature derive macro](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/analysis/derive.Feature.html).
...
attributes ([Attr](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/analysis/struct.Attr.html)
...
of [Attr](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/analysis/struct.Attr.html)
...
Clone, Eq,
and [Computable](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/analysis/trait.Computable.html)
traits.
