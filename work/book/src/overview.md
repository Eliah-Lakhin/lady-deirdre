...
using
the [derive macro](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/lexis/derive.Token.html)
...
the [derive macro](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/derive.Node.html).
...
From the [JSON example](https://github.com/Eliah-Lakhin/lady-deirdre/blob/f350aaed30373a67694c3aba4d2cfd9874c2a656/work/crates/examples/src/json_grammar/syntax.rs#L52):
...
full [ParseTree](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/syntax/struct.ParseTree.html)
...
and [TokenRef](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/lexis/struct.TokenRef.html)
...
of [attributes](https://docs.rs/lady-deirdre/2.2.0/lady_deirdre/analysis/struct.Attr.html).
...
[Chain Analysis](https://github.com/Eliah-Lakhin/lady-deirdre/blob/f350aaed30373a67694c3aba4d2cfd9874c2a656/work/crates/examples/src/chain_analysis/syntax.rs)
example.
...
From the [Chain Analysis](https://github.com/Eliah-Lakhin/lady-deirdre/blob/f350aaed30373a67694c3aba4d2cfd9874c2a656/work/crates/examples/src/chain_analysis/mod.rs#L84) example:
